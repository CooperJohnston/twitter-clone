...
const FollowDaoFillTables_1 = require("./FollowDaoFillTables");
const UserDaoFillTables_1 = require("./UserDaoFillTables");
...
const fillUserTableDao = new UserDaoFillTables_1.FillUserTableDao();
const fillFollowTableDao = new FollowDaoFillTables_1.FillFollowTableDao();
main();
async function main() {
